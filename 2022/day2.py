...
round, the players each simultaneously choose one of Rock, Paper, or Scissors using a hand shape.
...
your opponent is going to play: A for Rock, B for Paper, and C for Scissors. The second column--"
...
Draw = 3
Loss = 0
single round score = shape + score

A Y - opponent chooses rock (A) and you choose paper (Y). score is paper (2) + win (6) = 8
B X - opponent chooses paper (B) and you choose rock (X). score is rock (1) + loss (0) = 1
C Z - opponent chooses scissors (C) and you choose scissors (Z). score is scissors (3) + draw (3) = 6
score = 8 + 1 + 6 = 15
...
d["Y"] = 2
d["Z"] = 3
d["A X"] = 3  # Rock vs. Rock. I draw
d["A Y"] = 6  # Rock vs. Paper. I win
d["A Z"] = 0  # Rock vs. Scissors. I lose.
d["B X"] = 0  # Paper vs. Rock. I lose.
d["B Y"] = 3  # Paper vs. Paper. I draw.
d["B Z"] = 6  # Paper vs. Scissors. I win.
d["C X"] = 6  # Scissors vs. Rock. I win.
d["C Y"] = 0  # Scissors vs. Paper. I lose.
d["C Z"] = 3  # Scissors vs. Scissors. I draw.
...
d["rock win"] = "paper"
d["rock draw"] = "rock"
d["rock lose"] = "scissors"
d["paper win"] = "scissors"
d["paper draw"] = "paper"
d["paper lose"] = "rock"
d["scissors win"] = "rock"
d["scissors draw"] = "scissors"
d["scissors lose"] = "paper"
...
for i in rounds:
    if i != "":
        ops_choice = d[i[0]]
        outcome = d[i[-1]]
        outcome_score = d[outcome]
        my_choice = d[ops_choice + " " + outcome]
        choice_score = d[my_choice]
        scores.append(outcome_score + choice_score)
total_score = sum(scores)
